...
<xsl:template match="formelements">
  ...
  <input name="caller" type="hidden" value="_bopLiqExpOpcEntFis.asp"/>
<table border="0" cellspacing="0" cellpadding="0">
<tr>
		<td align="middle">
		<p class="clsLblTitulo">Liquidación Vencimientos : Entrega Física  </p>
		</td>
</tr>
<tr>
		<td align="middle">
		<p class="clsLblTitulo">Compras o Derechos  </p>
		</td>
	</tr>
</table>
<br/>
...
<tr>
	<td>
		<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" style="WIDTH: 400px;">
		<tr class="ETIQUETA6"> 
		    <td style="TEXT-ALIGN: left" class="ETIQUETA6"><div align="left" >&#160;Ejercicios Cartera Disponible para Liquidar</div></td>    
	     </tr>
		</table>
	</td>
</tr>
<tr>
	...
	<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" style="WIDTH: 400px;">
			...
			<xsl:for-each select="datatables/datatable[@setid='ejercomp']/datarow">
			<tr>
...
<tr>
	<td>
		<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" style="WIDTH: 400px;">
		<tr class="ETIQUETA6"> 
		    <td style="TEXT-ALIGN: left" class="ETIQUETA6"><div align="left" >&#160;Expiraciones Cartera Disponible para Liquidar</div></td>    
	     </tr>
		</table>
	</td>
</tr>
<tr>
	...
	<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" style="WIDTH: 400px;">
			...
			<xsl:for-each select="datatables/datatable[@setid='expicomp']/datarow">
			<tr>
			  <td class="ContenidoGrilla" nowrap="si">
				<xsl:value-of select="dataitem[@campo='folio']"/></td>
			  <td class="ContenidoGrilla" nowrap="si">
