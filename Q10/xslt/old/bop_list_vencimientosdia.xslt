...
<tr>
		<td align="middle">
		<p class="clsLblTitulo">Vencimientos del Dia: <xsl:value-of select="datatables/datatable[@setid='1']/datarow/dataitem[@campo='fecha_negocio']"/></p>
		</td>
	</tr>
<tr>
		<td align="left">
		<p class="clsLblTitulo">Reporte a las: <xsl:value-of select="elem[@campo='fechareporte']/valor" /></p>
		</td>
	</tr>
</table>
<br/>
