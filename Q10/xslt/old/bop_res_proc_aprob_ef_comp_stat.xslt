...
<xsl:template match="formelements">
  ...
  <input name="caller" type="hidden" value="_bopLiqAproLiqEFis.asp"/>
<table border="0" cellspacing="0" cellpadding="0">
<tr>
		<td align="middle">
		<p class="clsLblTitulo">Aprobación Liquidaciones : Entrega Física  </p>
		</td>
</tr>
<tr>
		<td align="middle">
...
<tr>
	...
	<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" style="WIDTH: 400px;">
			...
			<xsl:for-each select="datatables/datatable[@setid='aprliqcomp']/datarow">
			<tr>
...
<tr>
	...
	<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" style="WIDTH: 400px;">
			...
			<xsl:for-each select="datatables/datatable[@setid='rchliqcomp']/datarow">
			<tr>
			  <td class="ContenidoGrilla" nowrap="si">
				<xsl:value-of select="dataitem[@campo='folio']"/></td>
			  <td class="ContenidoGrilla" nowrap="si">
