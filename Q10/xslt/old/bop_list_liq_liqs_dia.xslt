...
<xsl:template name="lista" match="formelements" mode="xmlverb">
  ...
  <script src="js/funcs_gen_cartaliq.js"></script>
...
<tr>
		<td align="middle">
		<p class="clsLblTitulo">Movimiento Diario de Liquidaciones  (<xsl:value-of select="datatables/datatable[@setid='2']/datarow/dataitem[@campo='fecha_negocio']"/>)</p>
		</td>
	</tr>
</table>
<br/>
...
<tr>
	<td>
		<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" width="100%">
		<tr class="ETIQUETA6"> 
		    <td style="TEXT-ALIGN: left" class="ETIQUETA6"><div align="left" >&#160;Contraparte Banco</div></td>    
	     </tr>
		</table>
	</td>
</tr>
<tr>
	...
	<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" width="100%">
			<tr>
					<td class="ContenidoEncaGrilla">Carta</td>
			...
			<tr>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:copy-of select="dataitem[@campo='cartabco']/*"/></td>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:copy-of select="dataitem[@campo='vercartaliqbco']/*"/></td>
...
<tr>
	<td align="center">
	<xsl:copy-of select="datatables/databuttons[@setid='0']/boton[@campo='procesacarta']/*"/>
	&#160;<xsl:copy-of select="formbuttons/boton[@campo='exporta']/*"/>
...
<tr>
	<td>
		<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" width="100%">
		<tr class="ETIQUETA6"> 
		    <td style="TEXT-ALIGN: left" class="ETIQUETA6"><div align="left" >&#160;Contraparte Empresas</div></td>    
	     </tr>
		</table>
	</td>
</tr>
<tr>
	...
	<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" width="100%">
			...
			<tr>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:copy-of select="dataitem[@campo='cartaemp']/*"/></td>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:copy-of select="dataitem[@campo='vercartaliqemp']/*"/></td>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:copy-of select="dataitem[@campo='folio_opcion']/*"/></td>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:value-of select="dataitem[@campo='estadoop']"/></td>
			  <td class="ContenidoGrilla" align="right" nowrap="si"><xsl:value-of select="dataitem[@campo='valorintrin']"/>
					<xsl:text> </xsl:text><xsl:value-of select="dataitem[@campo='moneliq']"/></td>
...
<tr>
	<td align="center">
	<xsl:copy-of select="datatables/databuttons[@setid='1']/boton[@campo='procesacartemp']/*"/>
	&#160;<xsl:copy-of select="formbuttons/boton[@campo='exporta']/*"/>
	&#160;<xsl:copy-of select="formbuttons/boton[@campo='imprime']/*"/>
