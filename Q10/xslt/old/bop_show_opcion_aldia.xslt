...
<xsl:template match="formelements">
  ...
  <script language="vbscript" src="vbs/ing_opcion.vbs"></script>
...
<table border="0" cellspacing="0" cellpadding="0" class="tablalayer" width="100%">
	<tr class="Etiqueta6"> 
		<td style="TEXT-ALIGN: left" class="ETIQUETA6" ><div align="left" >&#160;&#160;Estado Ingreso</div></td>    
	</tr>
  </table>
  </td>
</tr>
...
<td>
  ...
  <table  class="clsFinTabla" width="100%" background="images/Fondo_Fila.jpg">
	<tr>
	    <td nowrap="si">Estado Ingreso:</td>
		<td class="FilaDespliegue" nowrap="si"><xsl:value-of select="elem[@campo='estado_opcion']/valor" /></td> 
	   <td nowrap="si">Usuario Actualización:</td>
		<td class="FilaDespliegue" nowrap="si"><xsl:value-of select="elem[@campo='usuario_actualiz']/valor" /></td>    
	</tr>
	  <tr> 
	   <td nowrap="si" >Nombre Usuario:</td>
	   <td class="FilaDespliegue" nowrap="si"><xsl:value-of select="elem[@campo='trader_name']/valor" /></td>
	   <td  nowrap="si">Fecha Actualización :</td>
		<td class="FilaDespliegue" nowrap="si"><xsl:value-of select="elem[@campo='fecha_actualiz']/valor" />&#160;</td>
	</tr>
	</table>
</td>
</tr>
...
<td>
 <table  class="clsFinTabla" width="100%" background="images/Fondo_Fila.jpg">
	<tr>
		...
		<td class="FilaDespliegue"><xsl:value-of select="elem[@campo='monto_prima']/valor" />&#160;<xsl:value-of select="elem[@campo='moneda_pprima']/valor" /></td>
...
<td>
	<table border="0" cellspacing="0" cellpadding="0" class="tablalayer" width="100%">
	<tr class="Etiqueta6"> 
		<td style="TEXT-ALIGN: left" class="ETIQUETA6" ><div align="left" >&#160;&#160;Valorización - 
		TCR: <xsl:value-of select="elem[@campo='tipo_cambio_indic']/valor" /></div></td>    
	</tr>
  </table>
	</td>
</tr>
...
<td>
 <table  class="clsFinTabla" width="100%" background="images/Fondo_Fila.jpg">
	<tr>
	  <td nowrap="true">Valor Intrínseco :</td>
	  <td class="FilaDespliegue" nowrap="si"><xsl:value-of select="elem[@campo='valor_intrinseco']/valor" />&#160;<xsl:value-of select="elem[@campo='moneda_liquid']/valor" /></td>
	  <td nowrap="true">Delta :</td>
	  <td class="FilaDespliegue"  nowrap="si"><xsl:value-of select="elem[@campo='valor_delta']/valor" />&#160;</td>
	  <td nowrap="true">&#160;</td>
	   <td class="FilaDespliegue"  nowrap="si">&#160;</td>
	</tr>
	</table>
	</td>
</tr>
