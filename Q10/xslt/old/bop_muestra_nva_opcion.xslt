...
<td>
   <table  class="clsFinTabla" width="100%" background="images/Fondo_Fila.jpg">
	<tr>
	   ...
	   <td class="FilaDespliegue" nowrap="si"><xsl:value-of select="elem[@campo='nombre_contraparte']/valor" /></td>
	...
	<tr>
		...
		<xsl:choose>
		  <xsl:when test="elem[@campo='tipo_ope']/dato &gt; 1">
			<td class="FilaDespliegue"><xsl:value-of select="elem[@campo='nombre_contraparte']/valor" /></td>
		  </xsl:when>
		  <xsl:otherwise>
...
<td>
 <table  class="clsFinTabla" width="100%" background="images/Fondo_Fila.jpg">
	<tr>
		...
		<td class="FilaDespliegue" nowrap="si"><xsl:value-of select="elem[@campo='monto_prima']/valor" />
...
<td>&#160;</td>
 <br/>
	   ...
	   <center>
		<!--&#160;<xsl:copy-of select="formbuttons/boton[@campo='voucher']/*"/>-->
