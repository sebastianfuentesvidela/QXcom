...
<tr>
		<td align="middle">
		<p class="clsLblTitulo">Liquidación Vencimientos : Entrega Física  (<xsl:value-of select="datatables/datatable[@setid='2']/datarow/dataitem[@campo='fecha_negocio']"/>)</p>
		</td>
	</tr>
</table>
<br/>
...
<tr>
	<td>
		<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" width="100%">
		<tr class="ETIQUETA6"> 
		    <td style="TEXT-ALIGN: left" class="ETIQUETA6"><div align="left" >&#160;Cartera Disponible para Liquidar / Compras o Derechos</div></td>    
	     </tr>
		</table>
	</td>
</tr>
<tr>
	...
	<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" width="100%">
			<tr>
					<td class="ContenidoEncaGrilla">Ejercer</td>
					<td class="ContenidoEncaGrilla">Expirar</td>
					...
					<td class="ContenidoEncaGrilla" >T/C Eje</td>
			...
			<tr>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:copy-of select="dataitem[@campo='ejercomp']/*"/></td>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:copy-of select="dataitem[@campo='expicomp']/*"/></td>
			  ...
			  <td class="ContenidoGrilla" nowrap="si"><xsl:value-of select="dataitem[@campo='tipocambioeje']"/></td>
...
<tr>
	<td>
		<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" width="100%">
		<tr class="ETIQUETA6"> 
		    <td style="TEXT-ALIGN: left" class="ETIQUETA6"><div align="left" >&#160;Cartera Disponible para Liquidar / Ventas u Obligaciones</div></td>    
	     </tr>
		</table>
	</td>
</tr>
<tr>
	...
	<table  border="0" cellspacing="0" cellpadding="0" class="tablalayer" width="100%">
			...
			<tr>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:copy-of select="dataitem[@campo='ejervta']/*"/></td>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:copy-of select="dataitem[@campo='expivta']/*"/></td>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:copy-of select="dataitem[@campo='folio_opcion']/*"/></td>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:value-of select="dataitem[@campo='tipooper']"/></td>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:value-of select="dataitem[@campo='tipoopci']"/></td>
			  <td class="ContenidoGrilla" nowrap="si"><xsl:value-of select="dataitem[@campo='estilo']"/></td>
