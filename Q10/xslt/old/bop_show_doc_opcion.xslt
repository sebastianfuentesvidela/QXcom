...
<xsl:template match="formelements">
  ...
  <title>Documento Opción</title>
  <body leftmargin="4">
  <form name="Form1" method="POST" action="">

	<table width="100%">
	<tr>
		<td colspan="2" class="Titulo_sec" width="100%"><b>Documento Opción N° <xsl:value-of select="elem[@campo='nro_opcion']/valor" /></b></td>
	</tr>
	<tr>
		<td class="Titulo_sec" width="100%"><b>Fecha: <xsl:value-of select="elem[@campo='fecha_contable']/valor" /></b></td>
		<td width="20" align="right"><xsl:copy-of select="formbuttons/boton[@campo='imprime']/*"/></td>
	</tr>
	</table>
	<hr />
 ...
 <table  class="clsFinTabla" width="100%" background="images/Fondo_Fila.jpg">
	<tr>
		...
		<td class="FilaDespliegue"><xsl:value-of select="elem[@campo='monto_prima']/valor" />
			 <xsl:value-of select="elem[@campo='moneda_pprima']/valor" />&#160;</td>
