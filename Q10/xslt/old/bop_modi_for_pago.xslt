...
<table width="100%">
	<tr>
	  <td colspan="6" class="Titulo_sec" width="100%"><b>Modificación Medio de Pago </b></td>
	</tr>
	<tr>
		<td colspan="6" class="Titulo_sec" width="100%"><b>Opción Folio : <xsl:value-of select="elem[@campo='nro_opcion']/valor" /></b></td>
	</tr>
</table>
<hr/>
		...
		<td>
			<table  class="clsFinTabla" width="100%" background="images/Fondo_Fila.jpg">
				...
				<tr>
				   ...
				   <td class="FilaDespliegue" nowrap="true"><xsl:value-of select="elem[@campo='plazo_res']/valor" /> Días</td>
				   <td nowrap="true">&#160;</td>
				   <td class="FilaDespliegue" nowrap="true">&#160;</td>
				   <td nowrap="true">&#160;</td>
				   <td class="FilaDespliegue" nowrap="true">&#160;</td>
