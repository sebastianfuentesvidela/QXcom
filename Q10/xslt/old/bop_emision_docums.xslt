...
<td>
 ...
 <br/>
	   ...
	   <center>
		<!--<xsl:copy-of select="formbuttons/boton[@campo='envia_valida_opcion']/*"/>-->
		&#160;<xsl:copy-of select="formbuttons/boton[@campo='fax']/*"/>
		&#160;<xsl:copy-of select="formbuttons/boton[@campo='contrato']/*"/>
