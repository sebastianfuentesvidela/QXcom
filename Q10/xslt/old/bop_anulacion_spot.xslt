...
<xsl:template match="formelements">
  ...
  <script src="js/funcs_env_anula_spot.js"></script>
...
<table width="100%">
	<tr>
	  <td colspan="6" class="Titulo_sec" width="100%"><b>Detalle Spot Folio : <xsl:value-of select="elem[@campo='fol_spot']/valor" /> </b></td>
	</tr>
	<tr>
		<td colspan="6" class="Titulo_sec" width="100%"><b>Fecha : <xsl:value-of select="elem[@campo='fecha_neg']/valor" /></b></td>
	</tr>
	</table>
	<hr/>
...
<br/>
	<xsl:call-template name="getcontrol">
		<xsl:with-param name="camp" select="'nro_spot'"/>
	</xsl:call-template>
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	<tr> 
	<td align="center">
		&#160;<xsl:copy-of select="formbuttons/boton[@campo='anula']/*"/>
